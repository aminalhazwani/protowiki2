...
import ArticleLiveContent from './ArticleLiveContent.vue'
import ArticleMockContent from './ArticleMockContent.vue'
import { MOCK_WET_LEG_DISPLAY_TITLE } from './mockWetLegArticle'
import {
  globalSkin,
  globalTheme,
...
import type { ArticleLanguageLink } from '@/components/article/shared/articleLanguageLinks'
