 ...
 *
 * Variant is read from the ?variant=v1 query param (was a /v1 path segment in the
 * monorepo source — switched to a query param because protowiki2 auto-routes each
 * prototype folder to a single path and doesn't support per-prototype path params).
 */
